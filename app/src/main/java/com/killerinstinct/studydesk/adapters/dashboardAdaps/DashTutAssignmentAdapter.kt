...
class DashTutAssignmentAdapter (
    private val navController: NavController,
    private var list:List<Assignment>,
    private val context: Context
): RecyclerView.Adapter<DashTutAssignmentAdapter.DashTutAssignmentViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): DashTutAssignmentAdapter.DashTutAssignmentViewHolder {

        return DashTutAssignmentViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.assignment_card_rec, parent, false)
        )
    }

    override fun onBindViewHolder(holder: DashTutAssignmentAdapter.DashTutAssignmentViewHolder, position: Int) {
    ...
    inner class DashTutAssignmentViewHolder(view: View) : RecyclerView.ViewHolder(view) {
